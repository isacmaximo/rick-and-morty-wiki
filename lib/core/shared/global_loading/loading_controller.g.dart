...
mixin _$LoadingController on LoadingControllerBase, Store {
  late final _$isLoadingAtom = Atom(
    name: 'LoadingControllerBase.isLoading',
    context: context,
  );
  ...
  late final _$LoadingControllerBaseActionController = ActionController(
    name: 'LoadingControllerBase',
    context: context,
  );
  ...
  dynamic startLoading() {
    final _$actionInfo = _$LoadingControllerBaseActionController.startAction(
      name: 'LoadingControllerBase.startLoading',
    );
    try {
  ...
  dynamic stopLoading() {
    final _$actionInfo = _$LoadingControllerBaseActionController.startAction(
      name: 'LoadingControllerBase.stopLoading',
    );
    try {
